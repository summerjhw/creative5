...
<div id="app">
  <div class="pure-menu">
    <span class="pure-menu-heading">Mythical Pet Adoption</span>
    <ul class="pure-menu-list">
      ...
      <li class="pure-menu-item">
        <router-link to="/MyPets" class="pure-menu-link">My Pets</router-link>
        <p></p>
      </li>
      <li class="pure-menu-item">
...
.pure-menu-heading {
  ...
  font-size: 1.2em;
  padding: 20px 20px;
  background-color: rgb(56, 242, 183);
  margin-bottom: 10px;
}
